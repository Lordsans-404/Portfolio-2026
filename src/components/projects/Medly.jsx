...
import medly from '../../assets/pj-medly.png';
import medly2 from '../../assets/pj-medly-2.png';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start relative mb-8 lg:mb-0">
                ...
                <div className="order-1 lg:order-2 lg:col-span-5 flex flex-col justify-start lg:pl-4">
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif leading-tight tracking-tight text-white mb-2">
                        Medly <br />
                        <span className="relative lg:-top-4 text-3xl sm:text-3xl italic font-light text-gray-400 font-serif">On-Chain Medical Record</span>
                ...
                <div className="order-3 lg:col-span-5 lg:col-start-8 lg:mt-[-20px] lg:row-start-2 relative z-20 lg:w-lg">
                    <div className="relative">
                        

                        <p className="text-lg text-gray-300 font-light leading-relaxed mb-6">
                            A decentralized medical record system for secure and transparent patient data, With some key features :
                        </p>
                        <ul className="space-y-2 pl-4">
                            {[
                                "On-chain medical records",
                                "Secure access",
                                "Patient–doctor data view",
                ...
                <div className="lg:w-md order-4 lg:col-span-7 lg:col-start-1 lg:row-start-2 lg:absolute lg:top-16 right-8 z-10 mt-8 lg:-mt-20">
                    <div className="relative">
                        {/* Arrow connecting to secondary image */}
                        <div className="hidden lg:block absolute top-6 -left-20 transform translate-x-1/2 -translate-y-1/2">
                            <img src={SmArrow} alt="arrow" className="w-10 h-auto opacity-80 rotate-180 scale-x-[-1] -scale-y-100" />
                        </div>
                        {/* Decorative Stars */}
                        <div className="relative rounded-2xl lg:rounded-[1rem] overflow-hidden shadow-2xl border-2 border-white/90 group w-full ml-auto">
                            <img
                                src={medly2}
                                alt="Snap Dashboard"
                                className="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-105"
